...
server_port = 12000 #create a TCP client socket
...
msg = input("Enter a string to test if it is alphanumeric: ") #send the message to the TCP server
client_socket.send(msg.encode()) #return values from the server
