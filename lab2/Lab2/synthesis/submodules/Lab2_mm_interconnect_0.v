...
module Lab2_mm_interconnect_0 (
	...
	wire  [12:0] cmd_mux_008_src_channel;                                                   // cmd_mux_008:src_channel -> hex2_s1_agent:cp_channel
	...
	wire         cmd_mux_012_src_valid;                                                     // cmd_mux_012:src_valid -> hex1_s1_agent:cp_valid
	wire  [95:0] cmd_mux_012_src_data;                                                      // cmd_mux_012:src_data -> hex1_s1_agent:cp_data
	wire         cmd_mux_012_src_ready;                                                     // hex1_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire  [12:0] cmd_mux_012_src_channel;                                                   // cmd_mux_012:src_channel -> hex1_s1_agent:cp_channel
	wire         cmd_mux_012_src_startofpacket;                                             // cmd_mux_012:src_startofpacket -> hex1_s1_agent:cp_startofpacket
	wire         cmd_mux_012_src_endofpacket;                                               // cmd_mux_012:src_endofpacket -> hex1_s1_agent:cp_endofpacket
	...
	wire         hex1_s1_agent_rp_valid;                                                    // hex1_s1_agent:rp_valid -> router_014:sink_valid
	wire  [95:0] hex1_s1_agent_rp_data;                                                     // hex1_s1_agent:rp_data -> router_014:sink_data
	wire         hex1_s1_agent_rp_ready;                                                    // router_014:sink_ready -> hex1_s1_agent:rp_ready
	wire         hex1_s1_agent_rp_startofpacket;                                            // hex1_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire         hex1_s1_agent_rp_endofpacket;                                              // hex1_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire         hex1_s1_agent_rdata_fifo_src_valid;                                        // hex1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire  [33:0] hex1_s1_agent_rdata_fifo_src_data;                                         // hex1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire         hex1_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_012:in_0_ready -> hex1_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_012_out_0_valid;                                         // avalon_st_adapter_012:out_0_valid -> hex1_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_012_out_0_data;                                          // avalon_st_adapter_012:out_0_data -> hex1_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_012_out_0_ready;                                         // hex1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire   [0:0] avalon_st_adapter_012_out_0_error;                                         // avalon_st_adapter_012:out_0_error -> hex1_s1_agent:rdata_fifo_sink_error
	...
	Lab2_mm_interconnect_0_router_002 router_003 (
	...
	Lab2_mm_interconnect_0_router_004 router_004 (
	...
	Lab2_mm_interconnect_0_router_004 router_005 (
	...
	Lab2_mm_interconnect_0_router_002 router_006 (
	...
	Lab2_mm_interconnect_0_router_002 router_007 (
	...
	Lab2_mm_interconnect_0_router_002 router_008 (
	...
	Lab2_mm_interconnect_0_router_002 router_009 (
	...
	Lab2_mm_interconnect_0_router_002 router_010 (
	...
	Lab2_mm_interconnect_0_router_002 router_011 (
	...
	Lab2_mm_interconnect_0_router_002 router_012 (
	...
	Lab2_mm_interconnect_0_router_002 router_013 (
	...
	Lab2_mm_interconnect_0_router_002 router_014 (
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_010 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_011 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_mux cmd_mux_012 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_011 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Lab2_mm_interconnect_0_rsp_demux rsp_demux_012 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
